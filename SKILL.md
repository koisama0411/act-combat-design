...
- **审阅方向（默认随 md 一起出）**：转审阅级交互 HTML（范式见 [review-html-doc.md](references/review-html-doc.md)，空白模板 [`templates/blank-design-doc.html`](templates/blank-design-doc.html)）——给策划 / 美术评审"设计好不好"，含资源**概览**。
...
- **效果 / 养成演示** → [`苍岚-效果与养成-gacha演示.md`](output/characters/cang-lan/md/苍岚-效果与养成-gacha演示.md)（苍岚移植到《星澜纪》：技能附带 / 命座 / 养成物效果 + § 十 数值验证）
