...
- [meta-rules.md](references/meta-rules.md) — 🌟 42 条元规则 + 机制创新 5 步法（思维核心）
...
### Phase 6：整合产出
整合成 **markdown 草稿**跟用户确认。确认 OK 后，产出分**两个方向（建议分开，别塞一个文档）**：
- **审阅方向**：转审阅级交互 HTML（范式见 [review-html-doc.md](references/review-html-doc.md)，空白模板 [`templates/blank-design-doc.html`](templates/blank-design-doc.html)）——给策划 / 美术评审"设计好不好"，含资源**概览**。
...
4. **先 markdown 再落地**：Phase 6 先出 markdown 草稿，确认 OK 再转 HTML / xlsx。
...
- [meta-rules.md](references/meta-rules.md) — 🌟 42 条元规则 + 机制创新 5 步法
...
- [numbers-and-progression.md](references/numbers-and-progression.md) — 数值与养成（伤害公式 / 击破系统 / buff 叠加 / 抽卡命座哲学）
...
- [review-html-doc.md](references/review-html-doc.md) + [review-html-components.md](references/review-html-components.md) + [review-markup-kit.md](references/review-markup-kit.md) — **审阅方向**:审阅级 HTML 文档范式 + 组件实现 + 评审标记套件（配 [`templates/blank-design-doc.html`](templates/blank-design-doc.html)）
...
- **示例项目约定** → [`conventions/example-conventions.md`](conventions/example-conventions.md)（虚构项目《孤刃行》）
- **示例角色** → [`output/characters/cang-lan/md/苍岚-战斗设计.md`](output/characters/cang-lan/md/苍岚-战斗设计.md)（薙刀女武者，「势」蓄力节奏机制）
